...
class Color_palette: 
    ...
    def __init__(self): 
        ...
        self.win.set_title("Palette Generator 1.3")
        ...
        label_dark=gtk.Label("Adjust light")
        start_dark=gtk.Adjustment(0,0,100,1,10,0)
    ...
    def cambia_colori(self,data):
        ...
        darker=self.dark.get_value()/100.0
        col_primario = grapefruit.Color.NewFromHsl(col_primario.hsl[0], col_primario.hsl[1], col_primario.hsl[2]).ColorWithLightness(darker)
        ...
        if data=="complementare":
            col_complementare = grapefruit.Color.NewFromHsl(col_complementare.hsl[0], col_complementare.hsl[1], col_complementare.hsl[2]).ColorWithLightness(darker)
        ...
        if data=="secondarioA":
            col_secondarioA = grapefruit.Color.NewFromHsl(col_secondarioA.hsl[0], col_secondarioA.hsl[1], col_secondarioA.hsl[2]).ColorWithLightness(darker)
        ...
        if data=="secondarioB":
            col_secondarioB = grapefruit.Color.NewFromHsl(col_secondarioB.hsl[0], col_secondarioB.hsl[1], col_secondarioB.hsl[2]).ColorWithLightness(darker)
    ...
    def crea_palette(self,dir,nome_file,estensione):
        ...
        black="0 0 0 Black\n" 
        bw01="25 25 25 Gray 10%\n"
        bw02="51 51 51 Gray 20%\n"
        bw03="76 76 76 Gray 30%\n"
        bw04="102 102 102 Gray 40%\n"
        bw05="127 127 127 Gray 50%\n"
        bw06="153 153 153 Gray 60%\n"
        bw07="178 178 178 Gray 70%\n"
        bw08="204 204 204 Gray 80%\n"
        bw09="229 229 229 Gray 90%\n"
        white="255 255 255 White\n" 

        #colore primario
        c01_rgb=str(int(self.c01_hex[1:3], 16))+" "+str(int(self.c01_hex[3:5], 16))+" "+str(int(self.c01_hex[5:7], 16))
        c02_rgb=str(int(self.c02_hex[1:3], 16))+" "+str(int(self.c02_hex[3:5], 16))+" "+str(int(self.c02_hex[5:7], 16))
        c03_rgb=str(int(self.c03_hex[1:3], 16))+" "+str(int(self.c03_hex[3:5], 16))+" "+str(int(self.c03_hex[5:7], 16))
        c04_rgb=str(int(self.c04_hex[1:3], 16))+" "+str(int(self.c04_hex[3:5], 16))+" "+str(int(self.c04_hex[5:7], 16))
        c05_rgb=str(int(self.c05_hex[1:3], 16))+" "+str(int(self.c05_hex[3:5], 16))+" "+str(int(self.c05_hex[5:7], 16))

        testo_primario=c01_rgb+" primario_01"+"\n"+c02_rgb+" primario_02"+"\n"+c03_rgb+" primario_03"+"\n"+c04_rgb+" primario_04"+"\n"+c05_rgb+" primario_05"+"\n"

        if armonia=="Mono":
            tutto=testo01+black+bw01+bw02+bw03+bw04+bw05+bw06+bw07+bw08+bw09+white+testo_primario

        elif armonia=="Complement":
            #colore complementare
            c06_rgb=str(int(self.c06_hex[1:3], 16))+" "+str(int(self.c06_hex[3:5], 16))+" "+str(int(self.c06_hex[5:7], 16))
            c07_rgb=str(int(self.c07_hex[1:3], 16))+" "+str(int(self.c07_hex[3:5], 16))+" "+str(int(self.c07_hex[5:7], 16))
            c08_rgb=str(int(self.c08_hex[1:3], 16))+" "+str(int(self.c08_hex[3:5], 16))+" "+str(int(self.c08_hex[5:7], 16))
            c09_rgb=str(int(self.c09_hex[1:3], 16))+" "+str(int(self.c09_hex[3:5], 16))+" "+str(int(self.c09_hex[5:7], 16))
            c10_rgb=str(int(self.c10_hex[1:3], 16))+" "+str(int(self.c10_hex[3:5], 16))+" "+str(int(self.c10_hex[5:7], 16))

            testo_complementare=c06_rgb+" complementare_01"+"\n"+c07_rgb+" complementare_02"+"\n"+c08_rgb+" complementare_03"+"\n"+c09_rgb+" complementare_04"+"\n"+c10_rgb+" complementare_05"+"\n"
            tutto=testo01+black+bw01+bw02+bw03+bw04+bw05+bw06+bw07+bw08+bw09+white+testo_primario+testo_complementare

        elif armonia in ("Triadic", "Analogous"):
            #colore secondario A
            c11_rgb=str(int(self.c11_hex[1:3], 16))+" "+str(int(self.c11_hex[3:5], 16))+" "+str(int(self.c11_hex[5:7], 16))
            c12_rgb=str(int(self.c12_hex[1:3], 16))+" "+str(int(self.c12_hex[3:5], 16))+" "+str(int(self.c12_hex[5:7], 16))
            c13_rgb=str(int(self.c13_hex[1:3], 16))+" "+str(int(self.c13_hex[3:5], 16))+" "+str(int(self.c13_hex[5:7], 16))
            c14_rgb=str(int(self.c14_hex[1:3], 16))+" "+str(int(self.c14_hex[3:5], 16))+" "+str(int(self.c14_hex[5:7], 16))
            c15_rgb=str(int(self.c15_hex[1:3], 16))+" "+str(int(self.c15_hex[3:5], 16))+" "+str(int(self.c15_hex[5:7], 16))

            testo_secondarioA=c11_rgb+" secondario_A_01"+"\n"+c12_rgb+" secondario_A_02"+"\n"+c13_rgb+" secondario_A_03"+"\n"+c14_rgb+" secondario_A_04"+"\n"+c15_rgb+" secondario_A_05"+"\n"

            #colore secondario B
            c16_rgb=str(int(self.c16_hex[1:3], 16))+" "+str(int(self.c16_hex[3:5], 16))+" "+str(int(self.c16_hex[5:7], 16))
            c17_rgb=str(int(self.c17_hex[1:3], 16))+" "+str(int(self.c17_hex[3:5], 16))+" "+str(int(self.c17_hex[5:7], 16))
            c18_rgb=str(int(self.c18_hex[1:3], 16))+" "+str(int(self.c18_hex[3:5], 16))+" "+str(int(self.c18_hex[5:7], 16))
            c19_rgb=str(int(self.c19_hex[1:3], 16))+" "+str(int(self.c19_hex[3:5], 16))+" "+str(int(self.c19_hex[5:7], 16))
            c20_rgb=str(int(self.c20_hex[1:3], 16))+" "+str(int(self.c20_hex[3:5], 16))+" "+str(int(self.c20_hex[5:7], 16))
            
            testo_secondarioB=c16_rgb+" secondario_B_01"+"\n"+c17_rgb+" secondario_B_02"+"\n"+c18_rgb+" secondario_B_03"+"\n"+c19_rgb+" secondario_B_04"+"\n"+c20_rgb+" secondario_B_05"+"\n"

            tutto=testo01+black+bw01+bw02+bw03+bw04+bw05+bw06+bw07+bw08+bw09+white+testo_primario+testo_secondarioA+testo_secondarioB
            ...
            tutto=testo01+black+bw01+bw02+bw03+bw04+bw05+bw06+bw07+bw08+bw09+white+testo_primario+testo_complementare+testo_secondarioA+testo_secondarioB
